...
struct s_client_state{
  union{
    DATA(0x1A0, i32 server_tick);              // m_nServerTick
    DATA(0x1A4, i32 client_tick);              // m_nClientTick
    DATA(0x1A8, i32 delta_tick);               // m_nDeltaTick
    DATA(0x1A4, i32 signon_state);             // m_nSignonState
    DATA(0x4A84, i32 last_command_ack);       // last_command_ack
    DATA(0x4A7C, i32 last_outgoing_command);  // lastoutgoingcommand
    DATA(0x4A80, i32 choked_commands);        // chokedcommands
  };
};
...
enum class_ids{
  ...
  RocketTrail = 179,
  SmokeTrail = 180,
  CPropVehicleDriveable = 81,
  ParticleSmokeGrenade = 178,
  CParticleFire = 65,
  MovieExplosion = 177,
  ...
  CTeam = 107,
  CSun = 106,
  CParticlePerformanceMonitor = 66,
  CSpotlightEnd = 101,
  ...
  CRopeKeyframe = 86,
  CRagdollManager = 82,
  CPhysicsPropMultiplayer = 71,
  CPhysBoxMultiplayer = 69,
  CBasePropDoor = 16,
  CDynamicProp = 30,
  CPointCommentaryNode = 76,
  CPointCamera = 75,
  CPlayerResource = 74,
  CPlasma = 73,
  CPhysMagnet = 72,
  ...
  CAkimboBeretta = 2,
  CWeaponSDKMelee = 173,
  CBaseGrenadeProjectile = 12,
  CDAViewModel = 28,
  CSDKPlayerResource = 90,
  CSDKRagdoll = 91,
  CSDKPlayer = 89,
  CTEPlayerAnimEvent = 143,
  CSDKGameRulesProxy = 88,
  CWeaponCycler = 163,
  CTEFireBullets = 131,
  CSDKTeam_Deathmatch = 94,
  CSDKTeam_Red = 95,
  CSDKTeam_Blue = 93,
  CSDKTeam_Unassigned = 96,
  CSDKTeam = 92,
  CSparkler = 100,
  CRatRaceWaypoint = 85,
  CBriefcaseCaptureZone = 25,
  CBriefcase = 24,
};
...
{
public:
  c_interface_steamuser* steamuser; //0x0004 == 0x000
