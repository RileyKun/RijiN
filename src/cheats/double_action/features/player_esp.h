  ...
  ALWAYSINLINE colour get_draw_colour(c_base_player* p, i32 colour_type = PLAYER_ESP_RENDER_TYPE_TEXT){
    ...
    switch(colour_type){
      ...
      case PLAYER_ESP_RENDER_TYPE_TEXT:
      {
        ...
        if(config->visual.player_esp_aimbot_target && p->get_index() == global->aimbot_target_index)
      ...
      case PLAYER_ESP_RENDER_TYPE_CHAMS:
      {
        ...
        if(config->visual.player_chams_aimbot_target && p->get_index() == global->aimbot_target_index)
      ...
      case PLAYER_ESP_RENDER_TYPE_CHAMS_OVERLAY:
      {
        ...
        if(config->visual.player_chams_overlay_aimbot_target && p->get_index() == global->aimbot_target_index)
      ...
      case PLAYER_ESP_RENDER_TYPE_GLOW:
      {
        ...
        if(config->visual.player_glow_aimbot_target && p->get_index() == global->aimbot_target_index)
