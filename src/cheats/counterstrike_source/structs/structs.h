...
struct s_input{
  union{
    DATA(0x108, c_user_cmd* commands);
  };
};
...
public:
  union{
    DATA(0x6C4, i32 ammo_type);
    DATA(0x8B8, i32 damage);
    DATA(0x8BC, float range);
    DATA(0x8C0, float range_modifier);
    DATA(0x8B4, i32 penetration);
    DATA(0x8C4, i32 bullets);
  };
};
