...
public:
  ...
  bool simulate_bullet = false;
  s_fof_spread_dump spread_dump;
...
public:
  ...
  void* fofplayer_firebullets_hook_trp                = nullptr;
  void* cmultiplayeranimstate_resetgesture_hook_trp   = nullptr;
