...
public:
  virtual bool should_hit(c_base_entity* ent, i32 mask);
...
public:
  ...
  s_trace ray(vec3 start, vec3 end, i32 mask, u32 trace_type = TRACE_EVERYTHING, c_base_entity* ignore_entity = nullptr, u32 custom_trace_filter = 0);
  s_trace ray_obb(vec3 start, vec3 end, vec3 mins, vec3 maxs, i32 mask, u32 trace_type = TRACE_EVERYTHING, c_base_entity* ignore_entity = nullptr, u32 custom_trace_filter = 0);
  s_trace ray_to_entity(vec3 start, vec3 end, i32 mask, c_base_entity* entity);
