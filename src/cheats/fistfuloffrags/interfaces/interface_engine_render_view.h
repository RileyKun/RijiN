...
public:
  ...
  ALWAYSINLINE void set_blend( float blend ){
    utils::virtual_call<4, void, float>(this, blend);
  }

  ALWAYSINLINE float get_blend(){
    return utils::virtual_call<5, float>(this);
  }
  ...
  ALWAYSINLINE void set_colour_modulation( colour clr ){
    ...
    utils::virtual_call<6, void, float*>(this, c);
  }

  ALWAYSINLINE colour get_colour_modulation(){
    float c[3];
    utils::virtual_call<7, void, float*>(this, &c[0]);
