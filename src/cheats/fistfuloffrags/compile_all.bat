...
::make %OLD_DIR% -DBUILD_FLAG_USE_SIMD=avx && cmake --build . -j%NUMBER_OF_PROCESSORS%
::make %OLD_DIR% -DBUILD_FLAG_USE_SIMD=sse2 && cmake --build . -j%NUMBER_OF_PROCESSORS%
::make %OLD_DIR% -DBUILD_FLAG_USE_SIMD=avx512f && cmake --build . -j%NUMBER_OF_PROCESSORS%
