...
// FULL CREDITS TO THIS CLASS: https://www.unknowncheats.me/forum/1208481-post1.html
...
public:
	...
	virtual void* Remove_Me_1(const char* name, void* = nullptr) = 0;
...
public:
	...
	virtual void         AddThreadedCall(IThreadedCall* tc) = 0;
 	...
 	virtual void         MsgColour( const colour &col, const char *fmt, ... ) = 0;
