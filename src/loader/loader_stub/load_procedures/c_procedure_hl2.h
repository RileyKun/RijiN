...
class c_procedure_hl2 : public c_procedure_base{
public:
  ...
  bool write_hooks() override{
    ...
    set_module(HASH("server.dll"));
    {
      add_hook(HASH("server_base_entity_fire_bullet_hook"), SIG("\x53\x8B\xDC\x83\xEC\x00\x83\xE4\x00\x83\xC4\x00\x55\x8B\x6B\x00\x89\x6C\x24\x00\x8B\xEC\x81\xEC\x00\x00\x00\x00\x56\x8B\xF1\x57\x89\x75\x00\xE8"), false);
    }
