...
class c_procedure_dods : public c_procedure_base{
public:
  ...
  bool write_hooks() override{
    ...
    set_module(HASH("client.dll"));
    {
      ...
      add_hook(HASH("override_view_hook"), SIG("\x55\x8B\xEC\x83\xEC\x4C\xE8\x00\x00\x00\x00"), false);
      ...
      // Search for "StopPlant" and sig the function it is in.
      add_hook(HASH("cdodplayer_clientthink_hook"), SIG("\x55\x8B\xEC\x83\xEC\x1C\x56\x57\x8B\xF9\xE8\x00\x00\x00\x00"), false);
      ...
      //v24 = sub_101C61D0();
      // (*(*v24 + 156))(v24, a2); <-----
      add_hook(HASH("do_post_screen_space_effects_hook"), SIG("\xB0\x00\xC2\x00\x00\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xB8"), false);
