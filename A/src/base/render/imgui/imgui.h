...
#define IMGUI_VERSION               XOR("1.87")
#define IMGUI_VERSION_NUM           XOR32(18700)
...
#define IMGUI_PAYLOAD_TYPE_COLOR_3F     XOR("_COL3F")    // float[3]: Standard type for colors, without alpha. User code may use this type.
#define IMGUI_PAYLOAD_TYPE_COLOR_4F     XOR("_COL4F")    // float[4]: Standard type for colors. User code may use this type.
