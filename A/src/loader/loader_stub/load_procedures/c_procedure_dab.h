...
class c_procedure_dab : public c_procedure_base{
public:
  ...
  bool write_signatures() override{
   ...
   set_module(HASH("engine.dll"));
   {
     ...
     add_signature(HASH("steam3client_addr"), SIG("\xE8\x00\x00\x00\x00\x83\x38\x00\x74\x00\xE8\x00\x00\x00\x00\x8D\x55\x00\x52\x8B\x08\x8B\x01\xFF\x50\x00\x8D\x45\x00\x50\xFF\x75"), true);
   }
  ...
  bool write_hooks() override{
    ...
    set_module(HASH("client.dll"));
    {
      ...
      add_hook(HASH("base_animating_setupbones_hook"), SIG("\x55\x8B\xEC\x81\xEC\x00\x00\x00\x00\xA1\x00\x00\x00\x00\x33\xC5\x89\x45\x00\x53\x8B\xD9\x8B\x0D\x00\x00\x00\x00\x56\x8B\x75\x00\x89\xB5\x00\x00\x00\x00\x83\xB9"), false);
      ...
      add_hook(HASH("csdkplayer_firebullet_hook"), SIG("\x55\x8B\xEC\x81\xEC\x00\x00\x00\x00\x56\x57\x8D\x45\x00\x8B\xF9"), false);

      add_hook(HASH("csdkplayershared_setrecoil_hook"), SIG("\x55\x8B\xEC\xA1\x00\x00\x00\x00\xD9\x05"), false);
    }
